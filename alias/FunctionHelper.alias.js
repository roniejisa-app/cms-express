...
class FunctionHelper {
    constructor() {
        this.defaultImage = process.env.VITE_BU + '/images/admin/no-image.svg';
        this.baseUrl = process.env.VITE_BU;
    }
    init() {}
    ...
    getImage(data) {
        try{
            ...
            if(checkObj && obj.path_absolute) return process.env.VITE_BU + '/' + obj.path_absolute;
        }catch(error){
